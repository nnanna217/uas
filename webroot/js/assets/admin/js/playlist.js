...
function PausePlay() {
    ...
    if (img.prop('src').indexOf('/App_Themes/default/images/pause-icon.png') >= 0) {

        img.prop('src', '/App_Themes/default/images/play-icon.png');
        ...
        img.prop('src', '/App_Themes/default/images/pause-icon.png');
