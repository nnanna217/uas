...
$(document).ready(function(){
  ...
  /*  if ($.cookie('color_schemes')) {
    ...
    var hidThemeStr = $("#hidTheme").val();
    var hidNavbarStr = $("#hidNavbar").val();
    var hidSidebarStr = $("#hidSidebar").val();

    if (hidThemeStr) {
        $('link#theme').attr('href', '/assets/admin/css/themes/' + hidThemeStr + '.theme.css');
    }
    ...
    if (hidNavbarStr) {
        $('.navbar-toolbar').attr('class', 'navbar navbar-toolbar navbar-' + hidNavbarStr);
    }
    ...
    if (hidSidebarStr) {
        // Check variant sidebar class
        if ($('#sidebar-left').hasClass('sidebar-box')) {
            $('#sidebar-left').attr('class', 'sidebar-box sidebar-' + hidSidebarStr);
        }
        else if ($('#sidebar-left').hasClass('sidebar-rounded')) {
            $('#sidebar-left').attr('class', 'sidebar-rounded sidebar-' + hidSidebarStr);
        }
        else if ($('#sidebar-left').hasClass('sidebar-circle')) {
            $('#sidebar-left').attr('class', 'sidebar-circle sidebar-' + hidSidebarStr);
        }
        else if ($('#sidebar-left').attr('class') == '') {
            $('#sidebar-left').attr('class', 'sidebar-' + hidSidebarStr);
        }
    }
