...
<?= $this->Html->script(['jquery/jquery.min.js', 'metisMenu/dist/metisMenu.min.js', 'raphael/raphael-min.js', 'morrisjs/morris.min.js', 'morris-data-3.js', 'morris-data.js', 'sb-admin-2.js']); ?>
