                ...
                <div class="">
                    <div class="" style="color:#fff">
                        <div class="heat" style="background:#808080; padding: 10px;">
                            ...
                            <h4 class="text-center"><i class="fa fa-lightbulb-o"></i> <b>INCIDENCE REPORT</b></h4>
                            <hr>
                            ...
                            <div style="margin-top:30px">
                                ...
                                <section>
                                    <span><h4><b>345</b></h4> Active Events</span>
                                ...
                                <section style="margin-top:30px">
                                    <span><h4><b>5013</b></h4> Terrorist  Attacks</span>
                                ...
                                <section style="margin-top:30px">
                                    <span><h4><b>150</b></h4> Border Smuggling</span>
                                ...
                                <section style="margin-top:30px">
                                    <span><h4><b>103</b></h4> Kidnapping</span>
                                ...
                                <section style="margin-top:30px">
                                    <span><h4><b>5473</b></h4> Cyber Threat</span>

                                    <div class="progress no-rounded">
                                        <div class="progress-bar progress-bar-greenbg" role="progressbar"
                                             aria-valuenow="80"
                                ...
                                <section style="margin-top:30px">
                                    <span><h4><b>12070</b></h4> Infrastructure Breach</span>
        ...
        <div class="col-md-6 col-xs-9">
            <div class="row">
                <div class="col-md-12">
                    <section>
                        <div id="static-map">
                            <img style="width: 100%; display: block; margin: auto" src="img/monitor.jpg""
                            class="">
                            <p class="text-primary text-center">2016-01-15</p>
                        </div>
                        <div id="video-feed">
                            <iframe style="width: 95%; margin: auto; display: block; height: 550px"
                                    src=""></iframe>
